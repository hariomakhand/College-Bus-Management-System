        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-white space-y-6 sm:space-y-8 text-center sm:text-left max-w-4xl mx-auto sm:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 sm:pt-6 justify-center sm:justify-start">
              <button 
                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-xl font-semibold hover:from-yellow-600 hover:to-yellow-700 transform hover:scale-105 transition-all duration-300 shadow-2xl"
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 mt-8 lg:mt-0">
              <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-lg text-center">
                <div className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-2">800+</div>
                <div className="text-sm sm:text-base text-gray-600">Active Students</div>
              </div>
              
              <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-lg text-center">
                <div className="text-2xl sm:text-3xl font-bold text-gray-600 mb-2">10+</div>
                <div className="text-sm sm:text-base text-gray-600">Bus Routes</div>
              </div>
              
              <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-lg text-center">
                <div className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-2">99.9%</div>
                <div className="text-sm sm:text-base text-gray-600">Uptime</div>
              </div>
              
              <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-lg text-center">
                <div className="text-2xl sm:text-3xl font-bold text-gray-600 mb-2">24/7</div>
      ...
      <section id="services" className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            <div className="group bg-white p-6 md:p-7 lg:p-8 rounded-2xl border border-gray-200 hover:border-yellow-300 hover:shadow-xl transition-all duration-300">
              <div className="w-12 h-12 md:w-13 md:h-13 lg:w-14 lg:h-14 bg-yellow-100 rounded-xl flex items-center justify-center mb-4 md:mb-5 lg:mb-6 group-hover:bg-yellow-500 transition-colors">
            ...
            <div className="group bg-white p-6 md:p-7 lg:p-8 rounded-2xl border border-gray-200 hover:border-gray-400 hover:shadow-xl transition-all duration-300">
              <div className="w-12 h-12 md:w-13 md:h-13 lg:w-14 lg:h-14 bg-gray-100 rounded-xl flex items-center justify-center mb-4 md:mb-5 lg:mb-6 group-hover:bg-gray-600 transition-colors">
                <span className="text-xl md:text-xl lg:text-2xl group-hover:text-white transition-colors">👥</span>
              </div>
            ...
            <div className="group bg-white p-6 md:p-7 lg:p-8 rounded-2xl border border-gray-200 hover:border-yellow-300 hover:shadow-xl transition-all duration-300 sm:col-span-2 md:col-span-1">
              <div className="w-12 h-12 md:w-13 md:h-13 lg:w-14 lg:h-14 bg-yellow-100 rounded-xl flex items-center justify-center mb-4 md:mb-5 lg:mb-6 group-hover:bg-yellow-500 transition-colors">
                <span className="text-xl md:text-xl lg:text-2xl group-hover:text-white transition-colors">🚗</span>
              </div>
            ...
            <div className="group bg-white p-6 md:p-7 lg:p-8 rounded-2xl border border-gray-200 hover:border-gray-400 hover:shadow-xl transition-all duration-300 sm:col-span-2 md:col-span-1">
              <div className="w-12 h-12 md:w-13 md:h-13 lg:w-14 lg:h-14 bg-gray-100 rounded-xl flex items-center justify-center mb-4 md:mb-5 lg:mb-6 group-hover:bg-gray-600 transition-colors">
                <span className="text-xl md:text-xl lg:text-2xl group-hover:text-white transition-colors">📊</span>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 mt-10">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:support@busmanagement.com" className="text-yellow-600 hover:text-yellow-700 font-medium">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 mt-8 lg:mt-0">
              ...
              <form onSubmit={(e) => {
                ...
                <button
                  type="submit"
                  className="w-full bg-yellow-500 text-white py-4 rounded-lg font-semibold hover:bg-yellow-600 transform hover:scale-105 transition-all duration-200 shadow-lg"
                >
